            ...
            <div class="row mb-50 wow fadeInUp" data-wow-delay="200ms">
                <div class="col-lg-12 d-flex align-items-center justify-content-between gap-3 flex-wrap">
                    <div class="section-title-2">
                        <h2>Voitures à l'honneur</h2>
                        <p>Voici quelques-unes des voitures à l'honneur dans différentes catégories</p>
                    </div>
                            ...
                            <div class="feature-card">
                                <div class="product-img">
                                    ...
                                    <div class="swiper product-img-slider">
                                        <div class="swiper-wrapper">
                                            <!-- Loop through car images -->
                                            <div class="swiper-slide" v-for="(image, idx) in car.images"
                                                :key="image.car_image_id">
                                                <img class="img-fluid" :src="image.image_url"
                                                    :alt="`Image ${idx + 1} of ${car.brand.brand_name} ${car.model.model_name}`" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="features">
                                        <li>
                                            <svg width="13" height="13" viewBox="0 0 13 13"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_611_72011" style="mask-type:alpha"
                                        ...
                                        <li>
                                            <svg width="13" height="13" viewBox="0 0 13 13"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_611_7231" style="mask-type:alpha"
                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="13" height="13">
                                                    <rect width="13" height="13"></rect>
                                                </mask>
                                        ...
                                        <li>
                                            <svg width="13" height="13" viewBox="0 0 13 13"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_611_7222" style="mask-type:alpha"
                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="13" height="13">
                                                    <rect width="13" height="13"></rect>
                                                </mask>
...
export default {
    ...
    mounted() {
        fetch("http://127.0.0.1:8000/api/en/cars/featured")
            .then((res) => res.json())
            .then((data) => {
                if (data.success) {
                    this.cars = data.cars;
                    // initialize or update swiper here if needed
                    // e.g. this.$nextTick(() => { initializeSwiper(); });
                    this.$nextTick(() => {
                        this.initSwiper();
                    });
                }
            })
            .catch((err) => console.error("Failed to fetch featured cars:", err));
    },
    methods: {
        initSwiper() {
            this.swiper = new Swiper('.home2-featured-slider', {
                slidesPerView: 'auto',
                spaceBetween: 30,
                loop: true,
                autoplay: {
