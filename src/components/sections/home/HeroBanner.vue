...
export default {
    ...
    setup() {
        ...
        const getTotalCars = async () => {
            try {
                const response = await axios.get(`http://127.0.0.1:8000/api/en/cars/count`)
                totalCars.value = response.data.data
            } catch (err) {
                console.error('Error fetching total cars:', err.message, err.response?.data);
                error.value = `Error fetching total cars: ${err.message}`;
            }
        }
        onMounted(() => {
            getTotalCars()
            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-7 d-flex align-items-center">
                    <div class="banner-content">
                        <span>ALLOCAR - Location de Véhicules</span>
                        <h1>Louez Votre Voiture Idéale</h1>
                        <p>ALLOCAR vous propose une large gamme de véhicules de qualité pour tous vos besoins de
                            déplacement. Location simple, rapide et sécurisée.</p>
                            ...
                            <div class="rating">
                                <a href="#">
                                    <div class="review-top">
                                        <div class="logo">
                                            <img src="/assets/img/star/trstpilot-logo.svg" alt="">
                                        </div>
                                        <div class="star">
                                            <img src="/assets/img/star/trustpilot-star.svg" alt="">
                                        </div>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li>Note de Confiance <span>4.8</span></li>
                                            <li><span>1547</span> Avis Clients</li>
                                        </ul>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="banner-img-group">
                        <div class="top-img-group">
                            <div class="top-left-card">
                                <div class="icon">
                                    <img src="assets/img/hero-features/banner-icon.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>{{ totalCars }}+</h4>
                            ...
                            <div class="top-right-img">
                                <img src="assets/img/hero-features/feature_1.png" alt="">
                            </div>
                        </div>

                        <div class="bottom-img-group">
                            <div class="bottom-left-img">
                                <img src="assets/img/hero-features/feature_2.png" alt="">
                            </div>
                            <div class="bottom-right-img">
                                <img src="assets/img/hero-features/feature_3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
