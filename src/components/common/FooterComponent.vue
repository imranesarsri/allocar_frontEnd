    ...
    <footer class="style-3">
        <div class="container-fluid">
            <div class="footer-top">
                <div
                    class="row row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-1 justify-content-center g-lg-4 gy-5 ">
                    <div class="col d-flex justify-content-lg-start">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h5>À propos d'ALLOCAR</h5>
                            </div>
                            <div class="menu-container">
                                <p class="text-white-footer">
                                    Votre partenaire de confiance en location de voitures
                                    Nous sommes ravis de vous accueillir dans notre communauté de voyageurs et
                                    d'aventuriers
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col d-flex justify-content-sm-center">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h5>Rechercher & Explorer</h5>
                            </div>
                            <div class="menu-container">
                                <ul>
                                    <li><a href="car-listing-left-sidebar.html">Voitures d'Occasion
                                    ...
                                    <li><a href="car-listing-left-sidebar.html">Voitures Neuves
                                            <svg width="10" height="10" viewBox="0 0 10 10"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M9.1605 0H0.849401C0.626751 0 0.413219 0.0884475 0.255781 0.245885C0.0983438 0.403323 0.00989626 0.616854 0.00989626 0.839505C0.00989626 1.06216 0.0983438 1.27569 0.255781 1.43312C0.413219 1.59056 0.626751 1.67901 0.849401 1.67901H7.13309L0.256291 8.55665C0.17611 8.63409 0.112154 8.72673 0.0681567 8.82915C0.0241591 8.93157 0.00100033 9.04173 3.16969e-05 9.1532C-0.000936937 9.26467 0.020304 9.37522 0.062515 9.47839C0.104726 9.58156 0.167062 9.67529 0.245885 9.75412C0.324709 9.83294 0.418441 9.89527 0.521613 9.93748C0.624785 9.9797 0.735331 10.0009 0.846799 9.99997C0.958268 9.999 1.06843 9.97584 1.17085 9.93184C1.27327 9.88785 1.36591 9.82389 1.44335 9.74371L8.32099 2.86649V9.1506C8.32099 9.37325 8.40944 9.58678 8.56688 9.74422C8.72431 9.90166 8.93785 9.9901 9.1605 9.9901C9.38315 9.9901 9.59668 9.90166 9.75412 9.74422C9.91155 9.58678 10 9.37325 10 9.1506V0.839505C10 0.616854 9.91155 0.403323 9.75412 0.245885C9.59668 0.0884475 9.38315 0 9.1605 0Z" />
                                    ...
                                    <li><a href="car-listing-left-sidebar.html">Location Longue Durée
                                            <svg width="10" height="10" viewBox="0 0 10 10"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M9.1605 0H0.849401C0.626751 0 0.413219 0.0884475 0.255781 0.245885C0.0983438 0.403323 0.00989626 0.616854 0.00989626 0.839505C0.00989626 1.06216 0.0983438 1.27569 0.255781 1.43312C0.413219 1.59056 0.626751 1.67901 0.849401 1.67901H7.13309L0.256291 8.55665C0.17611 8.63409 0.112154 8.72673 0.0681567 8.82915C0.0241591 8.93157 0.00100033 9.04173 3.16969e-05 9.1532C-0.000936937 9.26467 0.020304 9.37522 0.062515 9.47839C0.104726 9.58156 0.167062 9.67529 0.245885 9.75412C0.324709 9.83294 0.418441 9.89527 0.521613 9.93748C0.624785 9.9797 0.735331 10.0009 0.846799 9.99997C0.958268 9.999 1.06843 9.97584 1.17085 9.93184C1.27327 9.88785 1.36591 9.82389 1.44335 9.74371L8.32099 2.86649V9.1506C8.32099 9.37325 8.40944 9.58678 8.56688 9.74422C8.72431 9.90166 8.93785 9.9901 9.1605 9.9901C9.38315 9.9901 9.59668 9.90166 9.75412 9.74422C9.91155 9.58678 10 9.37325 10 9.1506V0.839505C10 0.616854 9.91155 0.403323 9.75412 0.245885C9.59668 0.0884475 9.38315 0 9.1605 0Z" />
                                    ...
                                    <li><a href="car-listing-left-sidebar.html">Louer ma Voiture
                                            <svg width="10" height="10" viewBox="0 0 10 10"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M9.1605 0H0.849401C0.626751 0 0.413219 0.0884475 0.255781 0.245885C0.0983438 0.403323 0.00989626 0.616854 0.00989626 0.839505C0.00989626 1.06216 0.0983438 1.27569 0.255781 1.43312C0.413219 1.59056 0.626751 1.67901 0.849401 1.67901H7.13309L0.256291 8.55665C0.17611 8.63409 0.112154 8.72673 0.0681567 8.82915C0.0241591 8.93157 0.00100033 9.04173 3.16969e-05 9.1532C-0.000936937 9.26467 0.020304 9.37522 0.062515 9.47839C0.104726 9.58156 0.167062 9.67529 0.245885 9.75412C0.324709 9.83294 0.418441 9.89527 0.521613 9.93748C0.624785 9.9797 0.735331 10.0009 0.846799 9.99997C0.958268 9.999 1.06843 9.97584 1.17085 9.93184C1.27327 9.88785 1.36591 9.82389 1.44335 9.74371L8.32099 2.86649V9.1506C8.32099 9.37325 8.40944 9.58678 8.56688 9.74422C8.72431 9.90166 8.93785 9.9901 9.1605 9.9901C9.38315 9.9901 9.59668 9.90166 9.75412 9.74422C9.91155 9.58678 10 9.37325 10 9.1506V0.839505C10 0.616854 9.91155 0.403323 9.75412 0.245885C9.59668 0.0884475 9.38315 0 9.1605 0Z" />
                    ...
                    <div class="col d-flex justify-content-lg-center justify-content-sm-end">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h5>Voitures par Marques</h5>
                            </div>
                            <div class="menu-container">
                                <ul>
                                    <!-- État de chargement -->
                                    <li v-if="brandsLoading">Chargement des marques...</li>

                                    <!-- Erreur de chargement -->
                                    <li v-else-if="brandsError">
                                        {{ brandsError }}
                                        <button @click="loadBrands">Réessayer</button>
                                    </li>

                                    <!-- Liste des marques -->
                                    <li v-for="brand in brands" :key="brand.id" v-else>
                                        <a :href="'single-brand-category.html?brand=' + brand.id">
                    ...
                    <div class="col d-flex justify-content-xl-center justify-content-lg-end justify-content-sm-center">
                        <div class="footer-widget">
                            <div class="widget-title">
                                <h5>Voitures par Ville</h5>
                            </div>
                            <div class="menu-container">
                                <ul>
                                    <!-- État de chargement -->
                                    <li v-if="citiesLoading">Chargement des villes...</li>

                                    <!-- Erreur de chargement -->
                                    <li v-else-if="citiesError">
                                        {{ citiesError }}
                                        <button @click="loadCities">Réessayer</button>
                                    </li>

                                    <!-- Liste des villes -->
                                    <li v-for="city in cities" :key="city.id" v-else>
                                        <a :href="'car-listing-left-sidebar.html?city=' + city.id">
            ...
            <div class="footer-center">
                <div class="footer-logo">
                    ...
                    <span class="brand-name">ALLOCAR</span>
                </div>
                <div class="contact-area">
                    <div class="hotline-area">
                        ...
                        <div class="content">
                            ...
                            <h6><a href="tel:+212537621432">+212-537 621 432</a></h6>
                        </div>
                    </div>
                    <div class="hotline-area">
                        <div class="icon">
                        ...
                        <div class="content">
                            <span>Pour nous envoyer un email</span>
                            <h6><a href="mailto:contact@allocar.ma">contact@allocar.ma</a></h6>
                        </div>
                    </div>
                </div>
                <div class="footer-btm-menu">
                    <ul>
                        <li><a href="#">Annoncer avec nous</a></li>
            ...
            <div class="footer-btm">
                <div class="copyright-area">
                    <p>Copyright 2023 <a href="#">ALLOCAR</a> | Design By <a href="#">Egens Lab</a></p>
                </div>
                <div class="social-area">
                    <h6>Suivez ALLOCAR:</h6>
                    <ul>
...
export default {
    ...
    data() {
        return {
            // Configuration API - URL CORRECTE confirmée
            apiBaseUrl: 'http://127.0.0.1:8000/api/fr/cars',
    ...
    methods: {
        async loadBrands() {
            ...
            try {
                // console.log('Tentative de chargement des marques depuis:', `${this.apiBaseUrl}/top8brands`);

                const response = await fetch(`${this.apiBaseUrl}/top8brands`, {
                    method: 'GET',
                    headers: {
                ...
                // console.log('Réponse API marques:', response.status, response.statusText);
                ...
                // console.log('Données brutes marques reçues:', result);

                // Extraire les données du format {success: true, data: [...]}
                if (result.success && result.data) {
                    this.brands = result.data;
                    // console.log('Marques traitées:', this.brands);
                } else {
                    throw new Error('Format de réponse API invalide');
                }

            } catch (error) {
                console.error('Erreur complète chargement marques:', error);
                this.brandsError = `Erreur: ${error.message}`;
            } finally {
        ...
        async loadCities() {
            ...
            try {
                // console.log('Tentative de chargement des villes depuis:', `${this.apiBaseUrl}/top8cities`);

                const response = await fetch(`${this.apiBaseUrl}/top8cities`, {
                    method: 'GET',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
                ...
                // console.log('Réponse API villes:', response.status, response.statusText);
                ...
                const result = await response.json();
                // console.log('Données brutes villes reçues:', result);

                // Extraire les données du format {success: true, data: [...]}
                if (result.success && result.data) {
                    this.cities = result.data;
                    // console.log('Villes traitées:', this.cities);
                } else {
                    throw new Error('Format de réponse API invalide');
                }

            } catch (error) {
                console.error('Erreur complète chargement villes:', error);
                this.citiesError = `Erreur: ${error.message}`;
            } finally {
